...
voterRoutes.patch('/updateEmail', authAdminMiddleware, (request: Request, response: Response) => {
...
voterRoutes.get('/findByRegistration', authAdminMiddleware, (request: Request, response: Response) => {
